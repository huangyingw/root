...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/huangyingw/.eclipse/org.eclipse.platform_3.5.0_155965261/plugins/org.eclim_1.6.1'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/huangyingw/.eclipse/org.eclipse.platform_3.5.0_155965261'
  if has('win32unix')
